...
tree is live), zoom for images (missing on the Mac too; PDFs and the LaTeX
preview have zoom now, item 4), and blur. Terminal links came after this
list was written, as item 9.
